...
@step(parsers.parse('открыт браузер "{browser_name}"'))
...
@step(parsers.parse('открыт браузер "{browser_name}" в режиме "{mode}"'))
...
@step(parsers.parse('установлен размер окна {width:d}x{height:d}'))
...
@step(parsers.parse('браузер развернут на весь экран'))
...
@step(parsers.parse('установлен таймаут ожидания элементов {timeout:d} секунд'))
...
@step(parsers.parse('установлен таймаут загрузки страницы {timeout:d} секунд'))
...
@step(parsers.parse('установлен таймаут выполнения скриптов {timeout:d} секунд'))
...
@step(parsers.parse('включен режим мобильной эмуляции "{device_name}"'))
...
@step(parsers.parse('установлен язык браузера "{language}"'))
...
@step(parsers.parse('включен режим инкогнито'))
...
@step(parsers.parse('отключены уведомления браузера'))
...
@step(parsers.parse('отключены всплывающие окна'))
...
@step(parsers.parse('установлен прокси "{proxy_url}" для браузера'))
...
@step(parsers.parse('загружено расширение браузера "{extension_path}"'))
...
@step(parsers.parse('пользователь авторизован в системе'))
...
@step(parsers.parse('пользователь авторизован как "{role}"'))
...
@step(parsers.parse('открыть страницу "{url}"'))
...
@step(parsers.parse('открыть страницу "{url}" в новой вкладке'))
...
@step(parsers.parse('перейти назад'))
...
@step(parsers.parse('перейти вперед'))
...
@step(parsers.parse('обновить страницу'))
...
@step(parsers.parse('принудительно обновить страницу'))
...
@step(parsers.parse('переключиться на вкладку {tab_index:d}'))
...
@step(parsers.parse('переключиться на вкладку с URL содержащим "{url_part}"'))
...
@step(parsers.parse('закрыть текущую вкладку'))
...
@step(parsers.parse('закрыть все вкладки кроме текущей'))
...
@step(parsers.parse('переключиться на iframe "{iframe_selector}"'))
...
@step(parsers.parse('переключиться на основной контент'))
...
@step(parsers.parse('переключиться на родительский фрейм'))
...
@step(parsers.parse('Логин в систему: логин {login}, пароль {password}'))
...
@step(parsers.parse('ввести логин "{login}"'))
...
@step(parsers.parse('ввести пароль "{password}"'))
...
@step(parsers.parse('нажать кнопку входа'))
...
@step(parsers.parse('выйти из системы'))
...
@step(parsers.parse('авторизоваться через SSO'))
...
@step(parsers.parse('авторизоваться через OAuth провайдер "{provider}"'))
...
@step(parsers.parse('кликнуть на элемент "{selector}"'))
...
@step(parsers.parse('кликнуть на элемент с текстом "{text}"'))
...
@step(parsers.parse('дважды кликнуть на элемент "{selector}"'))
...
@step(parsers.parse('кликнуть правой кнопкой на элемент "{selector}"'))
...
@step(parsers.parse('навести курсор на элемент "{selector}"'))
...
@step(parsers.parse('ввести текст "{text}" в поле "{selector}"'))
...
@step(parsers.parse('очистить поле "{selector}"'))
...
@step(parsers.parse('очистить и ввести текст "{text}" в поле "{selector}"'))
...
@step(parsers.parse('добавить текст "{text}" в поле "{selector}"'))
...
@step(parsers.parse('нажать клавишу "{key}"'))
...
@step(parsers.parse('нажать комбинацию клавиш "{keys}"'))
...
@step(parsers.parse('нажать Enter в поле "{selector}"'))
...
@step(parsers.parse('нажать Tab в поле "{selector}"'))
...
@step(parsers.parse('выбрать значение "{value}" в выпадающем списке "{selector}"'))
...
@step(parsers.parse('выбрать значение по индексу {index:d} в выпадающем списке "{selector}"'))
...
@step(parsers.parse('выбрать несколько значений в списке "{selector}":'))
...
@step(parsers.parse('установить чекбокс "{selector}"'))
...
@step(parsers.parse('снять чекбокс "{selector}"'))
...
@step(parsers.parse('переключить чекбокс "{selector}"'))
...
@step(parsers.parse('выбрать радиокнопку "{selector}"'))
...
@step(parsers.parse('загрузить файл "{file_path}" в поле "{selector}"'))
...
@step(parsers.parse('загрузить файлы в поле "{selector}":'))
...
@step(parsers.parse('перетащить элемент "{source}" на элемент "{target}"'))
...
@step(parsers.parse('прокрутить страницу вниз на {pixels:d} пикселей'))
...
@step(parsers.parse('прокрутить страницу вверх на {pixels:d} пикселей'))
...
@step(parsers.parse('прокрутить к элементу "{selector}"'))
...
@step(parsers.parse('прокрутить в начало страницы'))
...
@step(parsers.parse('прокрутить в конец страницы'))
...
@step(parsers.parse('ожидать появления элемента "{selector}"'))
...
@step(parsers.parse('ожидать появления элемента "{selector}" в течение {timeout:d} секунд'))
...
@step(parsers.parse('ожидать исчезновения элемента "{selector}"'))
...
@step(parsers.parse('ожидать исчезновения элемента "{selector}" в течение {timeout:d} секунд'))
...
@step(parsers.parse('ожидать кликабельности элемента "{selector}"'))
...
@step(parsers.parse('ожидать загрузки страницы'))
...
@step(parsers.parse('ожидать завершения AJAX запросов'))
...
@step(parsers.parse('ожидать текст "{text}" на странице'))
...
@step(parsers.parse('ожидать текст "{text}" в элементе "{selector}"'))
...
@step(parsers.parse('ожидать изменения URL на "{url}"'))
...
@step(parsers.parse('ожидать URL содержащий "{url_part}"'))
...
@step(parsers.parse('Сформировать отчет'))
...
@step(parsers.parse('заполнить форму:'))
...
@step(parsers.parse('заполнить форму данными:'))
...
@step(parsers.parse('отправить форму'))
...
@step(parsers.parse('отправить форму "{form_selector}"'))
...
@step(parsers.parse('сбросить форму'))
...
@step(parsers.parse('сбросить форму "{form_selector}"'))
...
@step(parsers.parse('выбрать дату "{date}" в календаре "{selector}"'))
...
@step(parsers.parse('выбрать диапазон дат с "{start_date}" по "{end_date}" в календаре "{selector}"'))
...
@step(parsers.parse('установить время "{time}" в поле "{selector}"'))
...
@step(parsers.parse('установить значение слайдера "{selector}" на {value:d}'))
...
@step(parsers.parse('кликнуть на строку {row:d} в таблице "{table_selector}"'))
...
@step(parsers.parse('кликнуть на ячейку в строке {row:d} колонке {col:d} таблицы "{table_selector}"'))
...
@step(parsers.parse('отсортировать таблицу "{table_selector}" по колонке "{column}"'))
...
@step(parsers.parse('отфильтровать таблицу "{table_selector}" по значению "{value}" в колонке "{column}"'))
...
@step(parsers.parse('перейти на страницу {page:d} в таблице "{table_selector}"'))
...
@step(parsers.parse('установить количество строк на странице {count:d} в таблице "{table_selector}"'))
...
@step(parsers.parse('выбрать все строки в таблице "{table_selector}"'))
...
@step(parsers.parse('снять выбор со всех строк в таблице "{table_selector}"'))
...
@step(parsers.parse('подтвердить диалоговое окно'))
...
@step(parsers.parse('отклонить диалоговое окно'))
...
@step(parsers.parse('ввести текст "{text}" в диалоговое окно'))
...
@step(parsers.parse('закрыть модальное окно'))
...
@step(parsers.parse('закрыть модальное окно "{modal_selector}"'))
...
@step(parsers.parse('нажать кнопку "{button_text}" в модальном окне'))
...
@step(parsers.parse('сделать скриншот'))
...
@step(parsers.parse('сделать скриншот с именем "{name}"'))
...
@step(parsers.parse('сделать скриншот элемента "{selector}"'))
...
@step(parsers.parse('сделать скриншот всей страницы'))
...
@step(parsers.parse('выполнить JavaScript:'))
...
@step(parsers.parse('выполнить JavaScript "{script}"'))
...
@step(parsers.parse('Проверить наличие элемента "{selector}" на странице'))
...
@step(parsers.parse('элемент "{selector}" отображается на странице'))
...
@step(parsers.parse('элемент "{selector}" не отображается на странице'))
...
@step(parsers.parse('элемент "{selector}" существует на странице'))
...
@step(parsers.parse('элемент "{selector}" не существует на странице'))
...
@step(parsers.parse('элемент "{selector}" активен'))
...
@step(parsers.parse('элемент "{selector}" неактивен'))
...
@step(parsers.parse('элемент "{selector}" выбран'))
...
@step(parsers.parse('элемент "{selector}" не выбран'))
...
@step(parsers.parse('элемент "{selector}" содержит текст "{text}"'))
...
@step(parsers.parse('элемент "{selector}" имеет точный текст "{text}"'))
...
@step(parsers.parse('элемент "{selector}" не содержит текст "{text}"'))
...
@step(parsers.parse('элемент "{selector}" имеет значение "{value}"'))
...
@step(parsers.parse('элемент "{selector}" имеет атрибут "{attribute}" со значением "{value}"'))
...
@step(parsers.parse('элемент "{selector}" имеет CSS свойство "{property}" со значением "{value}"'))
...
@step(parsers.parse('элемент "{selector}" имеет класс "{class_name}"'))
...
@step(parsers.parse('элемент "{selector}" не имеет класс "{class_name}"'))
...
@step(parsers.parse('количество элементов "{selector}" равно {count:d}'))
...
@step(parsers.parse('количество элементов "{selector}" больше {count:d}'))
...
@step(parsers.parse('количество элементов "{selector}" меньше {count:d}'))
...
@step(parsers.parse('заголовок страницы равен "{title}"'))
...
@step(parsers.parse('заголовок страницы содержит "{text}"'))
...
@step(parsers.parse('URL страницы равен "{url}"'))
...
@step(parsers.parse('URL страницы содержит "{url_part}"'))
...
@step(parsers.parse('URL страницы соответствует паттерну "{pattern}"'))
...
@step(parsers.parse('страница содержит текст "{text}"'))
...
@step(parsers.parse('страница не содержит текст "{text}"'))
...
@step(parsers.parse('страница загружена полностью'))
...
@step(parsers.parse('на странице нет JavaScript ошибок'))
...
@step(parsers.parse('на странице нет консольных ошибок'))
...
@step(parsers.parse('таблица "{table_selector}" содержит {count:d} строк'))
...
@step(parsers.parse('таблица "{table_selector}" содержит строку с текстом "{text}"'))
...
@step(parsers.parse('ячейка в строке {row:d} колонке {col:d} таблицы "{table_selector}" содержит "{text}"'))
...
@step(parsers.parse('колонка "{column}" таблицы "{table_selector}" отсортирована по возрастанию'))
...
@step(parsers.parse('колонка "{column}" таблицы "{table_selector}" отсортирована по убыванию'))
...
@step(parsers.parse('модальное окно отображается'))
...
@step(parsers.parse('модальное окно "{modal_selector}" отображается'))
...
@step(parsers.parse('модальное окно не отображается'))
...
@step(parsers.parse('модальное окно содержит текст "{text}"'))
...
@step(parsers.parse('поле "{selector}" имеет ошибку валидации'))
...
@step(parsers.parse('поле "{selector}" имеет ошибку валидации "{error_text}"'))
...
@step(parsers.parse('поле "{selector}" не имеет ошибок валидации'))
...
@step(parsers.parse('форма валидна'))
...
@step(parsers.parse('форма невалидна'))
...
@step(parsers.parse('пользователь авторизован'))
...
@step(parsers.parse('пользователь не авторизован'))
...
@step(parsers.parse('отображается страница входа'))
...
@step(parsers.parse('отображается сообщение об ошибке авторизации'))
...
@step(parsers.parse('открыто {count:d} вкладок'))
...
@step(parsers.parse('cookie "{cookie_name}" существует'))
...
@step(parsers.parse('cookie "{cookie_name}" имеет значение "{value}"'))
...
@step(parsers.parse('cookie "{cookie_name}" не существует'))
...
@step(parsers.parse('localStorage содержит ключ "{key}"'))
...
@step(parsers.parse('localStorage содержит ключ "{key}" со значением "{value}"'))
...
@step(parsers.parse('sessionStorage содержит ключ "{key}"'))
...
@step(parsers.parse('вывести текст элемента "{selector}"'))
...
@step(parsers.parse('вывести значение элемента "{selector}"'))
...
@step(parsers.parse('вывести URL страницы'))
...
@step(parsers.parse('вывести заголовок страницы'))
...
@step(parsers.parse('вывести HTML элемента "{selector}"'))
...
@step(parsers.parse('закрыть браузер'))
