...
async def _astream_text(user_text: str) -> AsyncGenerator[str, None]:
    """Async generator that yields text for st.write_stream; status events render inline."""
...
if prompt := st.chat_input("Введите сообщение..."):
    ...
    with st.chat_message("assistant"):
        full_response = st.write_stream(_astream_text(prompt))
